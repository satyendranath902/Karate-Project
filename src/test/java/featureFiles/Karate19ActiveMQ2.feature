Feature: JMS REST API - Test Suite 19
  ...
  # syntax:  http://192.168.1.62:8161/api/message?destination=queue://orders.input
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://satyendra1.input"
    And header Connection = "Keep-Alive"
    And request "Hi, Satyendra"
    When method post
    Then status 200
    ...
    * print cookieJSId
    ...
    # http://192.168.1.62:8161/api/message/orders.input?type=queue

    * waitForMiliseconds(1000)

    # ************************* Consuming message starts here ***************************
    Given path "/api/message/satyendra1.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi, Satyendra"
